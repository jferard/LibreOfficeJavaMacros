...
public class ExampleHelper {
    public static ExampleHelper create(XScriptContext xScriptContext) {
        XComponentContext xContext = xScriptContext.getComponentContext();
        XMultiComponentFactory xFactory = xContext.getServiceManager();
        return new ExampleHelper(xContext, xFactory);
    ...
    public ExampleHelper(XComponentContext xContext, XMultiComponentFactory xFactory) {
